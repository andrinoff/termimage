...
- A C toolchain (cgo is enabled for the bundled `stb_image` decoder)
- A terminal that supports one of the rendering protocols (kitty, Ghostty, foot, wezterm, …) for manual testing
